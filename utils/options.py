...
def get_args():
    parser = argparse.ArgumentParser(description="Tmars Args")
    ######################## general settings ########################
    ...
    parser.add_argument("--pretrain_choice", default='RN50')  # whether use pretrained model
    ...
    # parser.add_argument("--image_model", default='ResNet50',type=str)
    ...
    parser.add_argument("--test_mode", type=str, default='sjj_test')
